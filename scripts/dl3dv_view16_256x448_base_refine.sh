...
# Refinement training (16 views) (4x nodes, 4 gpus per node, batch size 1 per gpu)
...
python -m src.main +experiment=dl3dv \
    ...
    checkpointing.resume_update_module=<view8_refine_checkpoint> \
    wandb.project=dl3dv-view16-256x448 \
    output_dir=checkpoints/resplat/dl3dv-view16-256x448/base-refine
